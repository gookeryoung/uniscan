...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.target_stack = QStackedWidget(self.groupBox)
        self.target_stack.setObjectName(u"target_stack")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.target_stack.sizePolicy().hasHeightForWidth())
        self.target_stack.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout.addWidget(self.target_stack)
        ...
        sizePolicy2.setHeightForWidth(self.list_area.sizePolicy().hasHeightForWidth())
        self.list_area.setSizePolicy(sizePolicy2)
