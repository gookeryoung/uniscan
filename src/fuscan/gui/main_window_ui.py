...
class Ui_MainWindow:
    def setupUi(self, MainWindow):
        ...
        self.load_rules_action.setObjectName("load_rules_action")
        self.edit_rules_action = QAction(MainWindow)
        self.edit_rules_action.setObjectName("edit_rules_action")
        self.export_csv_action = QAction(MainWindow)
        self.export_csv_action.setObjectName("export_csv_action")
        self.export_json_action = QAction(MainWindow)
        self.export_json_action.setObjectName("export_json_action")
        self.quit_action = QAction(MainWindow)
        self.quit_action.setObjectName("quit_action")
        self.select_path_action = QAction(MainWindow)
        self.select_path_action.setObjectName("select_path_action")
        self.scan_action = QAction(MainWindow)
        self.scan_action.setObjectName("scan_action")
        ...
        self.tab_scan_btn.setObjectName("tab_scan_btn")
        ...
        self.tab_rules_btn.setObjectName("tab_rules_btn")
        ...
        self.tab_history_btn.setObjectName("tab_history_btn")
        ...
        self.scan_tab_layout.setObjectName("scan_tab_layout")
        self.scan_tab_layout.setContentsMargins(0, 0, 0, 0)
        self.sidebar_splitter = QSplitter(self.scan_tab)
        self.sidebar_splitter.setObjectName("sidebar_splitter")
        ...
        self.setup_layout.setObjectName("setup_layout")
        ...
        self.target_group_layout.setObjectName("target_group_layout")
        ...
        self.scan_mode_layout.setObjectName("scan_mode_layout")
        self.scan_mode_combo = QComboBox(self.target_group)
        self.scan_mode_combo.addItem("")
        self.scan_mode_combo.addItem("")
        self.scan_mode_combo.addItem("")
        self.scan_mode_combo.setObjectName("scan_mode_combo")
        ...
        self.full_scan_page.setObjectName("full_scan_page")
        self.full_scan_layout = QHBoxLayout(self.full_scan_page)
        self.full_scan_layout.setObjectName("full_scan_layout")
        self.full_scan_layout.setContentsMargins(0, 0, 0, 0)
        self.full_scan_label = QLabel(self.full_scan_page)
        self.full_scan_label.setObjectName("full_scan_label")
        ...
        self.drive_select_page.setObjectName("drive_select_page")
        self.drive_buttons_layout = QHBoxLayout(self.drive_select_page)
        self.drive_buttons_layout.setSpacing(4)
        self.drive_buttons_layout.setObjectName("drive_buttons_layout")
        ...
        self.setup_action_bar.setObjectName("setup_action_bar")
        ...
        self.setup_btn_row.setObjectName("setup_btn_row")
        ...
        self.view_results_btn.setObjectName("view_results_btn")
        ...
        self.scanning_page.setObjectName("scanning_page")
        self.scanning_layout = QVBoxLayout(self.scanning_page)
        self.scanning_layout.setSpacing(12)
        self.scanning_layout.setObjectName("scanning_layout")
        self.scanning_layout.setContentsMargins(12, 24, 12, 12)
        self.lists_splitter = QSplitter(self.scanning_page)
        self.lists_splitter.setObjectName("lists_splitter")
        sizePolicy2 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.lists_splitter.sizePolicy().hasHeightForWidth())
        self.lists_splitter.setSizePolicy(sizePolicy2)
        ...
        self.skipped_dirs_group.setObjectName("skipped_dirs_group")
        self.skipped_dirs_layout = QVBoxLayout(self.skipped_dirs_group)
        self.skipped_dirs_layout.setObjectName("skipped_dirs_layout")
        self.skipped_dirs_list = QListWidget(self.skipped_dirs_group)
        self.skipped_dirs_list.setObjectName("skipped_dirs_list")
        ...
        self.matched_files_group.setObjectName("matched_files_group")
        self.matched_files_layout = QVBoxLayout(self.matched_files_group)
        self.matched_files_layout.setObjectName("matched_files_layout")
        self.matched_files_list = QListWidget(self.matched_files_group)
        self.matched_files_list.setObjectName("matched_files_list")
        ...
        self.scanning_btn_row.setObjectName("scanning_btn_row")
        ...
        self.results_page_layout.setObjectName("results_page_layout")
        self.results_page_layout.setContentsMargins(0, 4, 0, 0)
        self.results_top_bar = QFrame(self.results_page)
        self.results_top_bar.setObjectName("results_top_bar")
        sizePolicy3 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.results_top_bar.sizePolicy().hasHeightForWidth())
        self.results_top_bar.setSizePolicy(sizePolicy3)
        self.results_top_layout = QHBoxLayout(self.results_top_bar)
        self.results_top_layout.setSpacing(8)
        self.results_top_layout.setObjectName("results_top_layout")
        ...
        self.results_list_area.setObjectName("results_list_area")
        sizePolicy4 = QSizePolicy(QSizePolicy.Ignored, QSizePolicy.Preferred)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.results_list_area.sizePolicy().hasHeightForWidth())
        self.results_list_area.setSizePolicy(sizePolicy4)
        self.results_list_layout = QVBoxLayout(self.results_list_area)
        self.results_list_layout.setSpacing(4)
        self.results_list_layout.setObjectName("results_list_layout")
        ...
        self.path_filter_input.setObjectName("path_filter_input")
        ...
        self.rule_filter_combo.setObjectName("rule_filter_combo")

        self.filter_layout.addWidget(self.rule_filter_combo)

        self.group_mode_combo = QComboBox(self.filter_bar)
        self.group_mode_combo.setObjectName("group_mode_combo")
        ...
        sizePolicy4.setHeightForWidth(self.detail_area.sizePolicy().hasHeightForWidth())
        self.detail_area.setSizePolicy(sizePolicy4)
        ...
        self.detail_action_stack.setObjectName("detail_action_stack")
        self.detail_empty_action = QFrame()
        self.detail_empty_action.setObjectName("detail_empty_action")
        sizePolicy5 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.detail_empty_action.sizePolicy().hasHeightForWidth())
        self.detail_empty_action.setSizePolicy(sizePolicy5)
        self.detail_empty_action_layout = QHBoxLayout(self.detail_empty_action)
        self.detail_empty_action_layout.setSpacing(6)
        self.detail_empty_action_layout.setObjectName("detail_empty_action_layout")
        self.detail_empty_action_layout.setContentsMargins(8, 4, 8, 4)
        self.detail_action_title_label = QLabel(self.detail_empty_action)
        self.detail_action_title_label.setObjectName("detail_action_title_label")
        ...
        self.detail_action_hint.setObjectName("detail_action_hint")
        ...
        self.detail_nonempty_action.setObjectName("detail_nonempty_action")
        ...
        self.detail_nonempty_action_layout.setObjectName("detail_nonempty_action_layout")
        ...
        self.detail_prev_btn.setObjectName("detail_prev_btn")
        ...
        self.detail_next_btn.setObjectName("detail_next_btn")
        ...
        self.detail_nav_label.setObjectName("detail_nav_label")
        ...
        self.detail_open_location_btn.setObjectName("detail_open_location_btn")
        ...
        self.detail_main_stack.setObjectName("detail_main_stack")
        self.detail_empty_main = QFrame()
        self.detail_empty_main.setObjectName("detail_empty_main")
        self.detail_empty_main_layout = QVBoxLayout(self.detail_empty_main)
        self.detail_empty_main_layout.setObjectName("detail_empty_main_layout")
        ...
        self.detail_empty_hint.setObjectName("detail_empty_hint")
        ...
        self.detail_nonempty_main.setObjectName("detail_nonempty_main")
        ...
        self.detail_nonempty_main_layout.setObjectName("detail_nonempty_main_layout")
        ...
        self.detail_hits_title_label.setObjectName("detail_hits_title_label")
        ...
        self.detail_hits_table.setObjectName("detail_hits_table")
        ...
        self.detail_preview_title_label.setObjectName("detail_preview_title_label")
        ...
        self.detail_preview.setObjectName("detail_preview")
        ...
        self.rules_tab_layout.setObjectName("rules_tab_layout")
        ...
        self.rules_tree.setObjectName("rules_tree")
        ...
        self.scan_menu.setObjectName("scan_menu")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QCoreApplication.translate("MainWindow", "fuscan \u901a\u7528\u6587\u4ef6\u626b\u63cf\u5668", None)
        )
        self.load_rules_action.setText(QCoreApplication.translate("MainWindow", "\u52a0\u8f7d\u89c4\u5219...", None))
        # if QT_CONFIG(shortcut)
        self.load_rules_action.setShortcut(QCoreApplication.translate("MainWindow", "Ctrl+O", None))
        # endif // QT_CONFIG(shortcut)
        self.edit_rules_action.setText(QCoreApplication.translate("MainWindow", "\u7f16\u8f91\u89c4\u5219...", None))
        # if QT_CONFIG(shortcut)
        self.edit_rules_action.setShortcut(QCoreApplication.translate("MainWindow", "Ctrl+E", None))
        # endif // QT_CONFIG(shortcut)
        self.export_csv_action.setText(QCoreApplication.translate("MainWindow", "\u5bfc\u51fa CSV...", None))
        # if QT_CONFIG(shortcut)
        self.export_csv_action.setShortcut(QCoreApplication.translate("MainWindow", "Ctrl+S", None))
        # endif // QT_CONFIG(shortcut)
        self.export_json_action.setText(QCoreApplication.translate("MainWindow", "\u5bfc\u51fa JSON...", None))
        # if QT_CONFIG(shortcut)
        self.export_json_action.setShortcut(QCoreApplication.translate("MainWindow", "Ctrl+Shift+S", None))
        # endif // QT_CONFIG(shortcut)
        self.quit_action.setText(QCoreApplication.translate("MainWindow", "\u9000\u51fa(&Q)", None))
        # if QT_CONFIG(shortcut)
        self.quit_action.setShortcut(QCoreApplication.translate("MainWindow", "Ctrl+Q", None))
        # endif // QT_CONFIG(shortcut)
        self.select_path_action.setText(
            QCoreApplication.translate("MainWindow", "\u9009\u62e9\u626b\u63cf\u8def\u5f84...", None)
        )
        self.scan_action.setText(QCoreApplication.translate("MainWindow", "\u5f00\u59cb\u626b\u63cf", None))
        # if QT_CONFIG(shortcut)
        self.scan_action.setShortcut(QCoreApplication.translate("MainWindow", "F5", None))
        # endif // QT_CONFIG(shortcut)
        self.manual_action.setText(QCoreApplication.translate("MainWindow", "\u7528\u6237\u624b\u518c", None))
        # if QT_CONFIG(shortcut)
        self.manual_action.setShortcut(QCoreApplication.translate("MainWindow", "F1", None))
        # endif // QT_CONFIG(shortcut)
        self.about_action.setText(QCoreApplication.translate("MainWindow", "\u5173\u4e8e", None))
        self.settings_action.setText(QCoreApplication.translate("MainWindow", "\u8bbe\u7f6e...", None))
        # if QT_CONFIG(shortcut)
        self.settings_action.setShortcut(QCoreApplication.translate("MainWindow", "Ctrl+,", None))
        # endif // QT_CONFIG(shortcut)
        self.tab_scan_btn.setText(QCoreApplication.translate("MainWindow", "\u626b\u63cf", None))
        self.tab_rules_btn.setText(QCoreApplication.translate("MainWindow", "\u89c4\u5219\u7ba1\u7406", None))
        self.tab_history_btn.setText(QCoreApplication.translate("MainWindow", "\u626b\u63cf\u5386\u53f2", None))
        self.settings_btn.setText(QCoreApplication.translate("MainWindow", "\u8bbe\u7f6e", None))
        self.about_btn.setText(QCoreApplication.translate("MainWindow", "\u5173\u4e8e", None))
        self.target_group.setTitle(QCoreApplication.translate("MainWindow", "\u626b\u63cf\u76ee\u6807", None))
        self.scan_mode_combo.setItemText(0, QCoreApplication.translate("MainWindow", "\u5168\u76d8\u626b\u63cf", None))
        self.scan_mode_combo.setItemText(1, QCoreApplication.translate("MainWindow", "\u9009\u62e9\u76d8\u7b26", None))
        self.scan_mode_combo.setItemText(
            2, QCoreApplication.translate("MainWindow", "\u9009\u62e9\u6587\u4ef6\u5939", None)
        )

        # if QT_CONFIG(tooltip)
        self.scan_mode_combo.setToolTip(
            QCoreApplication.translate("MainWindow", "\u9009\u62e9\u626b\u63cf\u6a21\u5f0f", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.full_scan_label.setText(
            QCoreApplication.translate("MainWindow", "\u5c06\u626b\u63cf\u6240\u6709\u76d8\u7b26", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.select_path_btn.setText(QCoreApplication.translate("MainWindow", "\u9009\u62e9...", None))
        # if QT_CONFIG(tooltip)
        self.view_results_btn.setToolTip(
            QCoreApplication.translate("MainWindow", "\u67e5\u770b\u4e0a\u6b21\u626b\u63cf\u7ed3\u679c", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.view_results_btn.setText(QCoreApplication.translate("MainWindow", "\u67e5\u770b\u7ed3\u679c", None))
        self.scan_btn.setText(QCoreApplication.translate("MainWindow", "\u5f00\u59cb\u626b\u63cf", None))
        self.skipped_dirs_group.setTitle(
            QCoreApplication.translate("MainWindow", "\u8df3\u8fc7\u7684\u6587\u4ef6\u5939", None)
        )
        self.matched_files_group.setTitle(
            QCoreApplication.translate("MainWindow", "\u547d\u4e2d\u7684\u6587\u4ef6", None)
        )
        self.pause_resume_btn.setText(QCoreApplication.translate("MainWindow", "\u6682\u505c\u626b\u63cf", None))
        self.cancel_btn.setText(QCoreApplication.translate("MainWindow", "\u53d6\u6d88\u626b\u63cf", None))
        # if QT_CONFIG(tooltip)
        self.rescan_btn.setToolTip(
            QCoreApplication.translate("MainWindow", "\u8fd4\u56de\u914d\u7f6e\u9875\u91cd\u65b0\u626b\u63cf", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.rescan_btn.setText(QCoreApplication.translate("MainWindow", "\u91cd\u65b0\u626b\u63cf", None))
        # if QT_CONFIG(tooltip)
        self.export_btn.setToolTip(
            QCoreApplication.translate("MainWindow", "\u5bfc\u51fa\u626b\u63cf\u7ed3\u679c\u5230\u6587\u4ef6", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.export_btn.setText(QCoreApplication.translate("MainWindow", "\u5bfc\u51fa\u7ed3\u679c", None))
        self.path_filter_input.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "\u6309\u8def\u5f84\u7b5b\u9009...", None)
        )
        # if QT_CONFIG(tooltip)
        self.rule_filter_combo.setToolTip(
            QCoreApplication.translate("MainWindow", "\u6309\u89c4\u5219\u7b5b\u9009", None)
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        ...
        self.detail_action_hint.setText(
            QCoreApplication.translate("MainWindow", "\u672a\u9009\u4e2d\u4efb\u4f55\u9879", None)
        )
        # if QT_CONFIG(tooltip)
        self.detail_prev_btn.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "\u8df3\u8f6c\u5230\u4e0a\u4e00\u4e2a\u547d\u4e2d\u4f4d\u7f6e", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.detail_prev_btn.setText(QCoreApplication.translate("MainWindow", "\u4e0a\u4e00\u6761", None))
        # if QT_CONFIG(tooltip)
        self.detail_next_btn.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "\u8df3\u8f6c\u5230\u4e0b\u4e00\u4e2a\u547d\u4e2d\u4f4d\u7f6e", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.detail_next_btn.setText(QCoreApplication.translate("MainWindow", "\u4e0b\u4e00\u6761", None))
        self.detail_nav_label.setText(QCoreApplication.translate("MainWindow", "0 / 0", None))
        # if QT_CONFIG(tooltip)
        self.detail_open_location_btn.setToolTip(
            QCoreApplication.translate(
                "MainWindow", "\u5728\u6587\u4ef6\u7ba1\u7406\u5668\u4e2d\u6253\u5f00\u6240\u5728\u76ee\u5f55", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.detail_open_location_btn.setText(
            QCoreApplication.translate("MainWindow", "\u6253\u5f00\u6587\u4ef6\u4f4d\u7f6e", None)
        )
        self.detail_empty_hint.setText(
            QCoreApplication.translate(
                "MainWindow",
                "\u672a\u9009\u4e2d\u4efb\u4f55\u9879\n"
                "\u8bf7\u9009\u62e9\u5de6\u4fa7\u7ed3\u679c\u9879\u67e5\u770b\u8be6\u60c5",
        ...
        self.detail_hits_title_label.setText(
            QCoreApplication.translate("MainWindow", "\u547d\u4e2d\u89c4\u5219:", None)
        )
        ___qtablewidgetitem = self.detail_hits_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", "\u89c4\u5219\u540d", None))
        ___qtablewidgetitem1 = self.detail_hits_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", "\u4e25\u91cd\u7b49\u7ea7", None))
        ___qtablewidgetitem2 = self.detail_hits_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", "\u6761\u6570", None))
        ___qtablewidgetitem3 = self.detail_hits_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", "\u4f4d\u7f6e\u6570", None))
        ___qtablewidgetitem4 = self.detail_hits_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", "\u8be6\u60c5", None))
        ___qtablewidgetitem5 = self.detail_hits_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", "\u63cf\u8ff0", None))
        self.detail_preview_title_label.setText(
            QCoreApplication.translate("MainWindow", "\u5185\u5bb9\u9884\u89c8 (\u5173\u952e\u8bcd\u9ad8\u4eae):", None)
        )
        self.note_edit.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "\u5907\u6ce8/\u6279\u6ce8/\u5bfc\u51fa\u8bf4\u660e...", None)
        )
        self.rules_group.setTitle(QCoreApplication.translate("MainWindow", "\u89c4\u5219\u914d\u7f6e", None))
        self.load_rules_btn.setText(QCoreApplication.translate("MainWindow", "\u52a0\u8f7d\u89c4\u5219...", None))
        # if QT_CONFIG(tooltip)
        self.edit_rule_btn.setToolTip(
            QCoreApplication.translate("MainWindow", "\u7f16\u8f91\u9009\u4e2d\u7684\u89c4\u5219\u6587\u4ef6", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.edit_rule_btn.setText(QCoreApplication.translate("MainWindow", "\u7f16\u8f91", None))
        ...
        # if QT_CONFIG(tooltip)
        self.rules_file_list.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                "\u5df2\u52a0\u8f7d\u7684\u89c4\u5219\u6587\u4ef6\uff0c\u5217\u8868\u987a\u5e8f\u4ee3\u8868\u4f18\u5148\u7ea7\uff08\u4ece\u4f4e\u5230\u9ad8\uff09",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ___qtreewidgetitem1 = self.rules_tree.headerItem()
        ___qtreewidgetitem1.setText(2, QCoreApplication.translate("MainWindow", "\u6269\u5c55\u540d", None))
        ___qtreewidgetitem1.setText(1, QCoreApplication.translate("MainWindow", "\u4e25\u91cd\u7b49\u7ea7", None))
        ___qtreewidgetitem1.setText(0, QCoreApplication.translate("MainWindow", "\u89c4\u5219\u540d", None))
        self.history_label.setText(
            QCoreApplication.translate(
                "MainWindow", "\u626b\u63cf\u5386\u53f2\uff08\u53cc\u51fb\u5feb\u901f\u9009\u62e9\uff09", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.file_menu.setTitle(QCoreApplication.translate("MainWindow", "\u6587\u4ef6(&F)", None))
        self.scan_menu.setTitle(QCoreApplication.translate("MainWindow", "\u626b\u63cf(&S)", None))
        self.help_menu.setTitle(QCoreApplication.translate("MainWindow", "\u5e2e\u52a9(&H)", None))
