...
class Ui_HitDetailDialog:
    def setupUi(self, HitDetailDialog):
        ...
        self.hit_info_label.setObjectName("hit_info_label")
        ...
        if self.hits_table.columnCount() < 6:
            self.hits_table.setColumnCount(6)
    ...
    def retranslateUi(self, HitDetailDialog):
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("HitDetailDialog", "\u6761\u6570", None))
        ___qtablewidgetitem3 = self.hits_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("HitDetailDialog", "\u4f4d\u7f6e\u6570", None))
        ___qtablewidgetitem4 = self.hits_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("HitDetailDialog", "\u8be6\u60c5", None))
        ___qtablewidgetitem5 = self.hits_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("HitDetailDialog", "\u63cf\u8ff0", None))
