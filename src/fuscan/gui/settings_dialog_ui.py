...
#if QT_CONFIG(tooltip)
        self.scan_archives_check.setToolTip(QCoreApplication.translate("SettingsDialog", u"\u626b\u63cf\u538b\u7f29\u6587\u4ef6\u5185\u7684\u6587\u4ef6\u5185\u5bb9", None))
#endif // QT_CONFIG(tooltip)
        self.scan_archives_check.setText(QCoreApplication.translate("SettingsDialog", u"\u626b\u63cf\u538b\u7f29\u5305\uff08ZIP/RAR\uff09", None))
