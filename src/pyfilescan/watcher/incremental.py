...
from pyfilescan.scanner import ScanReport, ScanResult, ScanStats
...
from pyfilescan.scanner.scanner import default_extract_content
...
class IncrementalScanner:
    ...
    def _scan_entry(self, entry: FileEntry) -> ScanResult:
        """对单个文件应用所有规则。"""
        from pyfilescan.scanner.context import MatchContext
